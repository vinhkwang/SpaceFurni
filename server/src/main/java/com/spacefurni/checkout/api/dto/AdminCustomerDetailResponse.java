...
public record AdminCustomerDetailResponse(UUID id, String fullName, String email, String district, long orderCount,
        long lifetimeValueAmount, String currencyCode, Instant firstOrderAt, CustomerTier tier,
        List<AdminCustomerOrderSummaryResponse> recentOrders) {
}
