  ...
  function applyCode(): void {
    ...
    startSubmission(async () => {
      ...
      if (result.cart.priceBreakdown.appliedPromotionCode === null) {
        setFeedback({ tone: "error", text: dictionary.cart.thatCodeIsNotValid });
        return;
      }
      setCode("");
      setFeedback({
        tone: "success",
        text: dictionary.cart.promoApplied(result.cart.priceBreakdown.appliedPromotionCode),
      });
    });
  }
      ...
      {appliedPromotionCode === null ? (
        <div className="flex gap-2">
          <input
            ...
            placeholder={dictionary.cart.promoCodePlaceholder}
