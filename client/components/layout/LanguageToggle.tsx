...
const segmentClassName =
  "flex h-9.5 w-10 cursor-pointer items-center justify-center rounded-pill text-[10.5px] font-semibold uppercase tracking-[0.08em] transition-colors duration-200";
...
export function LanguageToggle() {
  ...
  return (
    <div
      ...
      className="flex h-[46px] items-center gap-0.5 rounded-pill bg-surface p-1"
    >
      <button
        type="button"
